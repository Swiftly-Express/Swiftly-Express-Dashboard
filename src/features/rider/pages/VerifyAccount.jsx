                ...
                <div className="space-y-6">
                  <YummyText>
                    ...
                    <div className="bg-[#F8F9FA] rounded-xl p-4">
                      ...
                      <p className="text-sm text-[#64748B]">{formData.phoneNumber || '768543'}</p>
                      <p className="text-sm text-[#64748B]">{formData.streetAddress || 'o87654dfgnmbvcgdfgh'}, {formData.city || 'mnbvncfxdgh'}, {formData.state || 'vbcb vghfd'}</p>
                    </div>
                    ...
                    <div className="bg-[#F8F9FA] rounded-xl p-4">
                      ...
                      <p className="text-sm text-[#64748B]">{formData.idType || 'Drivers License'}</p>
                      <p className="text-sm text-[#64748B]">ID: {formData.idNumber || '76567890'}</p>
                    </div>
                    ...
                    <div className="bg-[#F8F9FA] rounded-xl p-4">
                      ...
                      <p className="text-sm text-[#64748B]">{formData.vehicleType || 'Scooter'} - {formData.makeModel || ',mn,bmvcfgcvbn'} ({formData.year || '65'})</p>
                      <p className="text-sm text-[#64748B]">Plate: {formData.licensePlate || 'vgh442'}</p>
                    </div>
            ...
            <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center p-4 z-50">
              <div className="bg-white rounded-3xl shadow-2xl max-w-md w-full p-8 text-center animate-scale-in">
                <YummyText>
                  ...
                  <button
                    onClick={() => router.push('/rider/dashboard', 'back', 'pop')}
