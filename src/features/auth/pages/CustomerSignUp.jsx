    ...
    <IonPage>
      <IonContent className="ion-no-padding">
        ...
        <div className="bg-white min-h-screen justify-between grid grid-cols-1 lg:grid-cols-2 mx-auto py-6 lg:py-12 px-6 gap-6">
              ...
              <div className="space-y-4">
                ...
                <div className={`border border-gray-300 rounded-full [&>button]:border-0 ${googleLoading ? 'pointer-events-none' : ''}`}>
                  <div className={googleLoading ? 'btn-gradient-ring' : ''}>
                    ...
                    <button
                      type="button"
                      className={`w-full flex items-center justify-center gap-3 py-3 transition-transform duration-150 ${googleLoading ? 'relative z-10' : ''}`}
          ...
          <div className="hidden lg:flex relative bg-[#00B75A] rounded-[32px] p-12 flex-col justify-between overflow-hidden">
            {/* Text Content at Top */}
