...
const RiderSignup = () => {
  ...
  const googleAuthUrl = `${import.meta.env.VITE_API_BASE_URL || 'https://api.swiftlyxpress.com'}/api/auth/google?role=rider`;
              ...
              <div className="space-y-4">
                ...
                <div className={`border border-gray-300 rounded-full [&>button]:border-0 ${googleLoading ? 'pointer-events-none' : ''}`}>
                  <div className={googleLoading ? 'btn-gradient-ring' : ''}>
                    ...
                    <button type="button" className={`w-full flex items-center justify-center gap-3 py-3 transition-transform duration-150 ${googleLoading ? 'relative z-10' : ''}`} onClick={handleGoogleSignup} disabled={googleLoading}>
